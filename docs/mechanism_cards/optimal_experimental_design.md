...
- **Local OED** (`NUDGE-LIM-023`): the FIM is the *local* curvature at `θ₀`; the optimum is
...
- `NUDGE-LIM-023` — **local OED**: the optimum + reported gains are valid near `θ₀`; no
